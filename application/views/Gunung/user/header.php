        ...
        <div class="container">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              <li><a href="<?=site_url()?>/Makan/tampil"><i class="glyphicon glyphicon-plus"></i>Home</a></li>
              <li><a href="<?=site_url()?>/Makan/create"><i class="glyphicon glyphicon-plus"></i>Profile</a></li>
              <li><a href="<?=site_url()?>/Makan/create"><i class="glyphicon glyphicon-plus"></i>Tentang</a></li>
